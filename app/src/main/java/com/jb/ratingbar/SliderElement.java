...
class SliderElement
    ...
    public SliderElement(Context context, int partialViewId, int starWidth, int startHeight,
                         int padding) {
        super(context);
    ...
    public SliderElement(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SliderElement(Context context, AttributeSet attrs, int defStyleAttr) {
